...
class MerkleTreeModelTester extends FreeSpec with ChiselScalatestTester {
    "Software 2-to-1 Merkle Tree should return the proper hash" in {
    ...
    "Software 4-to-1 Merkle Tree should return the proper hash" in {
        val p = PoseidonParams(r = 64, c = 64, Rf = 8, Rp = 57, alpha = 5)
        val msg1 = Message("a", 3)
        val msg2 = Message("b", 3)
    ...
    "Software 2-to-1 Merkle Tree should return the proper hash (t = 5)" in {
        val p = PoseidonParams(r = 64, c = 64, Rf = 8, Rp = 57, t = 5, alpha = 5)
    ...
    "Software 4-to-1 Merkle Tree should return the proper hash (t = 5)" in {
        val p = PoseidonParams(r = 64, c = 64, Rf = 8, Rp = 57, t = 5, alpha = 5)
        val msg1 = Message("a", 5)
        val msg2 = Message("b", 5)
        val msg3 = Message("c", 5)
        val msg4 = Message("d", 5)
